...
class GeminiProvider(AIProvider):
    ...
    def generate_response(self, history: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        strong_instruction = (
            ...
            "STRICT VERIFICATION RULE: NEVER output a final 'DONE' message or claim you completed a visual task unless you have EXPLICITLY used visual_verify to confirm it worked, or the tool itself returned a verified success message. If it failed, YOU MUST TELL THE USER!"
        )
